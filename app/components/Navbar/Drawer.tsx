...
const Drawer = ({ children, isOpen, setIsOpen }: DrawerProps) => {
    ...
    return (
        ...
        >
            <section
                className={
                    "w-340px max-w-lg left-0 absolute bg-soft h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform " +
            ...
            <section
                className="w-screen h-full cursor-pointer text-white"
                onClick={() => {
                    setIsOpen(false);
                }}
            ></section>
